    ...
    <div className="border-b border-neutral-900 pb-4">
      ...
      <div className="px-4">
        {EXPERIENCES.map((experience, index) => {
          // Définition de styles spécifiques pour Busipart
          ...
          return (
            <motion.div 
              ...
              className="group mb-12 flex flex-wrap lg:justify-center items-start p-6 rounded-2xl transition-colors duration-300"
            >
              <motion.div
              ...
              >
                ...
                <div className={`flex items-center justify-center overflow-hidden transition-transform duration-500 group-hover:rotate-3 
                  ${isBusipart 
                    ? "w-36 h-36 lg:w-44 lg:h-44 bg-transparent" // Plus grand et transparent pour Busipart
                ...
                >
                  <Image 
                    ...
                    width={isBusipart ? 200 : 128} // Augmente la résolution source pour Busipart
            ...
            >
              <h6 className="mb-2 font-bold text-xl group-hover:text-purple-300 transition-colors">
                {experience.role} -{" "}
              ...
              <div className="flex flex-wrap gap-2">
                {experience.technologies.map((tech, i) => (
                  <span
                    key={i}
                    className="rounded bg-neutral-900 px-3 py-1 text-xs font-medium text-purple-500 border border-neutral-800 group-hover:border-purple-500/50 transition-colors"
                  >
                    {tech}
                  </span>
                ))}
